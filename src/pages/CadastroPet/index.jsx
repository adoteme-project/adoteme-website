  ...
  return (
    <>
      ...
      <div className="w-full flex justify-between gap-10">
        ...
        <Link to={'/ong/cadastrar-pet/resgatado/resgatado-local'} className="w-full px-12 py-20 bg-ong-div border-2 border-amarelo rounded-xl flex flex-col gap-3 items-center justify-center">
          <span className="rounded-full p-8 flex justify-center items-center bg-amarelo-select">
